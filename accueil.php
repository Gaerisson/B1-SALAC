...
<div class="PartieCentrale">
	<h1> "SA LAC" : <span class="lettresRouges"></span>ou
	...
	<p>La société "LAC" vous propose de louer votre appartement ou votre chambre-studio. Elle dispose de trois immeubles dont
		...
		<br> Le type d'appartement va du simple studio au grand T2, les chambres vont de deux couchages jusqu'à quatres couchages.
		<br> (Voir la description sur les pages suivantes).
		<br> La société "LAC" peut mettre aussi à votre disposition un ensemble de mobilier pour aménager votre appartement ou votre
		chambre
	</p>
